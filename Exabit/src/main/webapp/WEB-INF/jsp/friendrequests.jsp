...
<div id="wrapper">
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="form-group">
                    <label for="dv-username" class="control-label">User</label>
                    <input type="text" class="form-control" id="dv-username">
                </div>
            </div>
            <div class="col-md-3">
                <button type="button" class="btn btn-default dv-send-friend">Send Request</button>
            </div>
            <div class="col-md-5">
                <div class="dv-friend-rsp"></div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <td><button type="button" class="btn btn-info-outline dv-refresh-rq">Refresh</button></td>
                <div class="dv-table-header">
                    <div class="dv-table-title">Friend Requests</div>
                </div>
                <div class="dv-table-content">
                    <table class="table table-hover">
                        <thead>
                        <tr>
                            <th>Id FriendRequest</th>
                            <th>From</th>
                            <th></th>
                            <th></th>
                        </tr>
                        </thead>
                        <tbody id="dv-friend-reqs-to">
...
<!-- Template -->
<script type="text/template" id="dv-friend-req-gt">
    <td>{{= idFriendRequest }}</td>
    <td>{{= fromUserId }}</td>
    <td><button type="button" class="btn btn-info-outline dv-accept-rq">Accept</button></td>
    <td><button type="button" class="btn btn-info-outline dv-reject-rq">Reject</button></td>
</script>
...
<script>
    $(document).ready(function() {
        ...
        App.Events.registerFriendRequest('.dv-send-friend');
        var reqtome = new App.Views.RequestToMeTable();
        reqtome.render();

        $('.dv-refresh-rq').on('click', function () {

            App.UserFriendReqs = new App.Views.RequestToMeTable();
